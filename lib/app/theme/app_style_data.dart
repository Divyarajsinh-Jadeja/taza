...
class LightModeTheme extends AppTheme {
  ...
  @override
  TextStyle get interRegularW400TextStyle => TextStyle(
    fontSize: 14.sp,
  ...
  @override
  TextStyle get interMediumBoldW500TextStyle => TextStyle(
    fontSize: 16.0.sp,
  ...
  @override
  TextStyle get interSemiBoldW600TextStyle => TextStyle(
    fontSize: 16.0.sp,
  ...
  @override
  TextStyle get interBoldW700TextStyle => TextStyle(
    fontSize: 16.0.sp,
  ...
  TextFieldStyle get textFieldStyle => TextFieldStyle(
    ...
    errorStyle: interRegularW400TextStyle.copyWith(
      fontSize: 12.sp,
      fontWeight: FontWeight.w400,
  ...
  CustomAppBarStyle get appBarStyle => CustomAppBarStyle(
    ...
    groupTitleStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.white,
    ),
    groupSubTitleStyle: interBoldW700TextStyle.copyWith(
      fontSize: 18.sp,
      color: colors.white,
    ),
  );
  ...
  SmartTabBarStyle get smartTabBarStyle => SmartTabBarStyle(
    selectedTabTextStyle: interMediumBoldW500TextStyle.copyWith(
      color: colors.primary,
    ),
  ...
  FoodPageStyle get foodPageStyle => FoodPageStyle(
    ...
    selectedCategoryTextStyle: interBoldW700TextStyle.copyWith(
      color: colors.white,
    ),
    unselectedCategoryTextStyle: interBoldW700TextStyle.copyWith(
      color: colors.color9c9cA3,
    ),
  ...
  @override
  SmartCategoryRowStyle get smartCategoryRowStyle => SmartCategoryRowStyle(
    titleStyle: interBoldW700TextStyle.copyWith(
      color: colors.white,
      fontSize: 15.sp,
    ),
  ...
  CheckoutStyle get checkoutStyle => CheckoutStyle(
    ...
    subCardTitleStyle: interBoldW700TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color9c9cA3,
    ),
    savingTitleStyle: interBoldW700TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color1D1D1F,
    ),
    toPayTitleStyle: interBoldW700TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color1D1D1F,
    ),
    ...
    appliedTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 12.sp,
    ...
    tabDisableTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 13.sp,
    ...
    payUsingTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color9c9cA3,
    ),
    paymentTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 15.sp,
      color: colors.color1D1D1F,
    ),
    tipSelectedStyle: interBoldW700TextStyle.copyWith(
      fontSize: 11.sp,
      color: colors.black,
    ),
    ...
    couponWhiteStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.white,
    ),
  ...
  SearchBarStyle get searchBarStyle => SearchBarStyle(
    ...
    searchBarHintStyle: interRegularW400TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.color9c9cA3,
    ),
    searchBarTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.color1D1D1F,
    ),
  );
  ...
  HomeHeaderStyle get homeHeaderStyle => HomeHeaderStyle(
    ...
    addressTitleStyle: interRegularW400TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color9c9cA3,
    ),
  );
  ...
  FoodOptionCardStyle get foodOptionCardStyle => FoodOptionCardStyle(
    ...
    foodCardTagStyle: interBoldW700TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color00A4A2,
    ),
    foodCardTimeStyle: interBoldW700TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color1D1D1F,
    ),
    foodCardDurationStyle: interRegularW400TextStyle.copyWith(
      fontSize: 11.sp,
      color: colors.color58585C,
    ),
  ...
  LoginPageStyle get loginPageStyle => LoginPageStyle(
    skipButtonTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.white,
    ),
    tagTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 18.sp,
      color: colors.white,
    ),
    dividerColor: colors.color1D1D1F,
    continueButtonTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.white,
    ),
    ...
    errorTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.colorFF0000,
    ),
    bottomTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 11.sp,
      color: colors.color9c9cA3,
    ),
    termsAndPrivacyTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color1D1D1F,
    ),
    countryCodeTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.color1D1D1F,
    ),
    accountTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 20.sp,
      color: colors.color1D1D1F,
    ),
    lebelTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.primary,
    ),
  );
  ...
  OrderTrackingPageStyle get orderTrackingPageStyle => OrderTrackingPageStyle(
    ...
    payOnlineTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.primary,
    ),
    headerBgColor: colors.primary,
    titleTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color1D1D1F,
    ),
    dividerColor: colors.colorF5F5F7,
    subtitleTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color1D1D1F,
    ),
    payOnlineSubTitleStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color1D1D1F,
    ),
    headerTagStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.white,
    ),
    headerTitleStyle: interBoldW700TextStyle.copyWith(
      fontSize: 18.sp,
      color: colors.white,
    ),
    ...
    tipAmountTextStyle: interMediumBoldW500TextStyle.copyWith(
      color: colors.color1D1D1F,
    ),
  ...
  AnimatedTabBarStyle get animatedTabBarStyle =>
      AnimatedTabBarStyle(transparentColor: colors.transparent);
  ...
  NotchedMsgStyle get notchedMsgStyle => NotchedMsgStyle(
    ...
    notchedTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 12.sp,
  ...
  @override
  CategorySidebarStyle get categorySidebarStyle => CategorySidebarStyle(
    borderColor: colors.color9c9cA3,
    primaryColor: colors.primary,
    transparentColor: colors.transparent,
    whiteColor: colors.white,
    shadowColor: colors.color8C8C8C,
    selectedTitleTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.primary,
    ),
    unSelectedTitleTextStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color1D1D1F,
    ),
  );
  ...
  FoodDetailsPageStyle get foodDetailsPageStyle => FoodDetailsPageStyle(
    ...
    rattingTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.color9c9cA3,
    ),
    timeTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.color9c9cA3,
    ),
    titleTextStyle: interBoldW700TextStyle.copyWith(
    ...
    descriptionTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 17.sp,
      color: colors.color9c9cA3,
    ),
    maxSaverPriceTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 17.sp,
      color: colors.black,
    ),
    maxSaverTitleStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color30D158,
    ),
    addButtonStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.color30D158,
    ),
    highlightTitleStyle: interMediumBoldW500TextStyle.copyWith(
      fontSize: 15.sp,
      color: colors.color1D1D1F,
    ),
    highlightDescriptionStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 15.sp,
      color: colors.black,
    ),
  );
  ...
  OtpPageStyle get otpPageStyle => OtpPageStyle(
    enterOtpButtonTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.white,
    ),
    ...
    subTitlesTextStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 13.sp,
      color: colors.color9c9cA3,
    ),
    verifyTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 19.sp,
      color: colors.color1D1D1F,
    ),
    headerCardColor: colors.colorF1F5FD,
    otpInputTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 18.sp,
      color: colors.primary,
    ),
    activeColor: colors.primary,
    ...
    callBoxTitleStyle: interSemiBoldW600TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.primary,
    ),
  );
  ...
  @override
  ProductListViewStyle get productListViewStyle => ProductListViewStyle(
    categoryHeaderStyle: interSemiBoldW600TextStyle.copyWith(fontSize: 22.sp),
    itemsStyle: interSemiBoldW600TextStyle.copyWith(fontSize: 14.sp),
    categorysubHeaderStyle: interRegularW400TextStyle.copyWith(
      fontSize: 16.sp,
      color: colors.color9c9cA3,
    ),
  ...
  @override
  PromotionalBannerStyle get promotionBannerStyle => PromotionalBannerStyle(
    headline: interBoldW700TextStyle.copyWith(
      color: colors.colorFFF86D,
      fontSize: 22.sp,
      letterSpacing: 1.2,
    ),
    subtitle: interRegularW400TextStyle.copyWith(
      color: colors.white,
      fontSize: 14.sp,
    ),
    buttonTextStyle: interMediumBoldW500TextStyle,
    whiteColor: colors.white,
    boxDecoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [colors.color3E1F16, colors.color7B3F29],
  ...
  @override
  ProductCardStyle get productCardStyle => ProductCardStyle(
    imageBackgroundColor: colors.colorF5F5F7,
    imageIconColor: colors.color9c9cA3,
    deliveryIconColor: colors.color9c9cA3,
    deliveryTimeTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color9c9cA3,
    ),
    nameTextStyle: interBoldW700TextStyle.copyWith(fontSize: 15.sp),
    sizeTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.color9c9cA3,
    ),
    discountedPriceTextStyle: interBoldW700TextStyle.copyWith(fontSize: 16.sp),
    originalPriceTextStyle: interRegularW400TextStyle.copyWith(
      decoration: TextDecoration.lineThrough,
      fontSize: 14.sp,
      color: colors.color9c9cA3,
    ),
    addButtonBackgroundColor: colors.transparent,
    addButtonBorderColor: colors.color00A4A2,
    addButtonTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 14.sp,
      color: colors.color00A4A2,
    ),
    discountBadgeColor: colors.colorFF3B30,
    discountBadgeTextStyle: interBoldW700TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.white,
    ),
  );
