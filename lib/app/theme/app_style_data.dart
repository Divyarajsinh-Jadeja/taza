...
class LightModeTheme extends AppTheme {
  ...
  ProductCardStyle get productCardStyle => ProductCardStyle(
    ...
    nameTextStyle: interBoldW700TextStyle.copyWith(fontSize: 13.sp),
    sizeTextStyle: interRegularW400TextStyle.copyWith(
      fontSize: 12.sp,
      color: colors.color9c9cA3,
    ),
    discountedPriceTextStyle: interBoldW700TextStyle.copyWith(fontSize: 14.sp),
